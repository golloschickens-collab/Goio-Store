import AgenteExploradoraImperial from './castas/exploradora.js';
import { mergeDeep } from './templates/agente-autonomo-imperial.js';

const CICLO_MS = parseInt(process.env.EXPLORADORA_CICLO_MS ?? '900000', 10);
...
(async () => {
  ...
  const agente = new AgenteExploradoraImperial(mergeDeep(baseConfig, argsConfig.config || {}));
